...
/* harmony import */ var _reducers_reducers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../reducers/reducers */ "./reducers/reducers.js");
...
var store = Object(redux__WEBPACK_IMPORTED_MODULE_1__["createStore"])(_reducers_reducers__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
store.dispatch(Object(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["addTodo"])('Learn about actions'));
store.dispatch(Object(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["addTodo"])('Learn about reducers'));
store.dispatch(Object(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["addTodo"])('Learn about store'));
store.dispatch(Object(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["toggleTodo"])(0));
store.dispatch(Object(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["toggleTodo"])(1));
store.dispatch(Object(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["setVisibilityFilter"])(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["VisibilityFilters"].SHOW_COMPLETED)); // Stop listening to state updates
...
var SHOW_ALL = _actions_actions__WEBPACK_IMPORTED_MODULE_3__["VisibilityFilters"].SHOW_ALL;
...
function visibilityFilter() {
  ...
  switch (action.type) {
    case _actions_actions__WEBPACK_IMPORTED_MODULE_3__["SET_VISIBILITY_FILTER"]:
...
function todos() {
  ...
  switch (action.type) {
    case _actions_actions__WEBPACK_IMPORTED_MODULE_3__["ADD_TODO"]:
      return [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(state), [{
        text: action.text,
        completed: false
      }]);

    case _actions_actions__WEBPACK_IMPORTED_MODULE_3__["TOGGLE_TODO"]:
      return state.map(function (todo, index) {
        if (index === action.index) {
          return _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, todo, {
