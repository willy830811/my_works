  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ShopItem, [{
    ...
    value: function render() {
      ...
      var star = react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("img", {
        ...
        __self: this
      }); //<li className="col-12 col-md-4" style={{position: 'relative', backgroundColor: '#ffffff', padding: '12px 19px 8px 6px', marginBottom: '10px', borderRadius: '2px', boxShadow: '0 2px 4px 0 rgba(163, 162, 162, 0.5)'}} onClick={this.props.onClick}>
      //</li>
...
//# sourceMappingURL=index.js.4349a70fb2afb3472de4.hot-update.js.map